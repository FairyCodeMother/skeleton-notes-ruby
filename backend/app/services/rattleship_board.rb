...
Keep the Marker, Board, and Rattleship classes in here
- Change any global constants (ex: SQUARE_SIZE, ALL_MARKERS) to class constants or passed as parameters.
- Make the board size configurable.
- Add method to your Rattleship class (ex: Rattleship#as_json) that returns the board as JSON.
